...
namespace DAL.Converters
{
    ...
    /// </summary>
    public class ContractorCategoryConverter : BaseConverter
    {
        /// <summary>
        ...
        public static ContractorCategory FromDictionaryToModel(Dictionary<string, object> dictionary, string modelId)
        {
            ContractorCategory model = new ContractorCategory()
            {
                Id = modelId,
        ...
        public static Dictionary<string, object> FromModelToDictionary(ContractorCategory model)
        {
