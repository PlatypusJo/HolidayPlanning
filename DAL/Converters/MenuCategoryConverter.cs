...
{
    /// <summary>
    /// Статический класс-конвертер для сущности Категория меню, для передачи данных в Firebase и принятия данных из него
    /// </summary>
    public class MenuCategoryConverter : BaseConverter
    {
        /// <summary>
        ...
        public static MenuCategory FromDictionaryToModel(Dictionary<string, object> dictionary, string modelId)
        {
        ...
        public static Dictionary<string, object> FromModelToDictionary(MenuCategory model)
        {
